...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, LGUI(KC_6),   KC_CALC, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                    KC_LGUI,KC_LALT,KC_LCTRL, KC_RAISE, KC_ENT,      KC_SPC, KC_RAISE,  KC_RCTRL, KC_RALT, KC_RGUI
),
